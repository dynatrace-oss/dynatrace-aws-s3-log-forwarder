...
echo "Creating the SSM parameter"
...
echo "Deploying the log forwarder template"
...
echo "Deploying the forwarder configuration template"
...
echo "Deploying the S3 bucket configuration template"
